...
class Sidebar(ctk.CTkFrame):
    def __init__(self, master, callbacks, **kwargs):
        ...
        self.btn_login = NavButton(self.bottom_frame, text="Zaloguj / Otwórz Sesję", icon_text="🔑", 
...
class SalesView(ctk.CTkFrame):
    def __init__(self, master, callbacks, mapping_templates, **kwargs):
        ...
        self.btn_upo = ctk.CTkButton(self.toolbar, text="Sprawdź UPO", command=callbacks['check_upo'], corner_radius=8, fg_color=BTN_COLOR, hover_color=BTN_HOVER)
        ...
        self.table_label = ctk.CTkLabel(self.table_container, text="[ Tu pojawi się lista wysłanych faktur ]", font=FONT_UI, text_color="gray")
...
class PurchasesView(ctk.CTkFrame):
    def __init__(self, master, callbacks, **kwargs):
        ...
        self.btn_sync = ctk.CTkButton(self.toolbar, text="Pobierz z KSeF", command=callbacks['sync'], corner_radius=8, fg_color=BTN_COLOR, hover_color=BTN_HOVER)
        ...
        self.table_label = ctk.CTkLabel(self.table_container, text="[ Tu pojawi się lista faktur zakupowych ]", font=FONT_UI, text_color="gray")
        self.table_label.pack(expand=True, pady=100)
...
class KSeFViewV4(ctk.CTk):
    ...
    def update_ui(self, model):
        ...
        self.header.set_title(f"Witaj, {model.user_name}!")
