...
<xsl:param name="schema-krajow" select="'KodyKrajow_v10-0E.xsd'"/>
				...
				<xsl:with-param name="nazwa">
					<xsl:choose>
						<xsl:when test="tns:Fa/tns:RodzajFaktury = 'VAT'">
							<xsl:text>Faktura podstawowa / Basic Invoice</xsl:text>
						</xsl:when>
						<xsl:when test="tns:Fa/tns:RodzajFaktury = 'KOR'">
							<xsl:text>Faktura korygująca / Correction Invoice</xsl:text>
						</xsl:when>
						...
						<xsl:when test="tns:Fa/tns:RodzajFaktury = 'KOR_ZAL'">
							<xsl:text>Faktura korygująca / Correction Invoice fakturę dokumentującą otrzymanie zapłaty lub jej części przed dokonaniem czynności oraz fakturę wystawioną w związku z art. 106f ust. 4 ustawy (faktura korygująca fakturę zaliczkową)</xsl:text>
						</xsl:when>
						<xsl:when test="tns:Fa/tns:RodzajFaktury = 'KOR_ROZ'">
							<xsl:text>Faktura korygująca / Correction Invoice fakturę wystawioną w związku z art. 106f ust. 3 ustawy</xsl:text>
						</xsl:when>
					</xsl:choose>
				</xsl:with-param>
			</xsl:call-template>
	...
	<xsl:template name="NrFaktury">
		<table class="break-word" width="100%">
			<tr>
				<td>
					Kod waluty / Currency code (ISO 4217):
					<b>
			...
			<tr>
				<td>
					Kolejny numer faktury / Sequential invoice number, nadany w ramach jednej lub więcej serii, który w sposób jednoznaczny identyfikuje fakturę: 
				<b>
			...
			<tr>
				<td>
				Data wystawienia / Date of issue, z zastrzeżeniem art. 106na ust. 1 ustawy: 
				<b>
	...
	<xsl:template name="SprzedawcaNabywca">
		...
		<table class="break-word">
			...
			<tr>
				<td style="width:50%">
					<xsl:text>Kod kraju / Country code: </xsl:text>
					...
					<tr>
						...
						<td style="width:50%">
							...
							<xsl:if test="tns:IDWew">
								<xsl:text>Identyfikator wewnętrzny z NIP / Tax ID: </xsl:text>
		...
		<xsl:if test="tns:Fa/tns:FaWiersz">
			<table class="white-space">
				<tr>
					...
					<td class="niewypelniane">Cena jedn. / Unit priceostkowa</td>
					<td class="niewypelniane">Opusty i obniżki cen</td>
					<td class="niewypelniane">Wartość sprzedaży</td>
					<td class="niewypelniane">Kwota / Amount VAT</td>
					...
					<td class="niewypelniane">Kwota / Amount podatku akcyzowego zawarta w cenie towaru</td>
				...
				<xsl:for-each select="tns:Fa/tns:FaWiersz">
					<tr>
						...
						<td class="prawa" width="auto">
							<xsl:value-of select="tns:Kwota / AmountAkcyzy"/>
						</td>
						<td class="srodek" width="auto">
							<xsl:if test="tns:GTU">
		...
		<xsl:if test="tns:Fa/tns:P_13_1|tns:Fa/tns:P_14_1|tns:Fa/tns:P_13_2|tns:Fa/tns:P_14_2|tns:Fa/tns:P_13_3|tns:Fa/tns:P_14_3|tns:Fa/tns:P_13_6_1|tns:Fa/tns:P_13_6_2|tns:Fa/tns:P_13_6_3|tns:Fa/tns:P_13_7|tns:Fa/tns:P_13_4|tns:Fa/tns:P_14_4|tns:Fa/tns:P_13_5">
			...
			<table class="break-word" width="60%">
				<tr>
					...
					<td class="niewypelniane" width="12%">Suma / Total wartości sprzedaży netto</td>
					<td class="niewypelniane" width="12%">Kwota / Amount podatku od sumy wartości sprzedaży netto</td>
					<td class="niewypelniane" width="12%">Kwota / Amount podatku od sumy wartości sprzedaży netto, przeliczona zgodnie z przepisami Działu VI ustawy</td>
					<td class="niewypelniane" width="12%">Kwota / Amount podatku od wartości dodanej w przypadku procedury szczególnej, o której mowa w dziale XII w rozdziale 6a ustawy</td>
					<td>
						<table width="10%">
							<tbody>
								<tr>
		...
		<table>
			<tr>
				<td>
					...
					Kwota / Amount należności ogółem: 
					</xsl:if>
					...
					Kwota / Amount pozostała do zapłaty: 
					</xsl:if>
				...
				<xsl:if test="tns:Obciazenia">
					...
					<table class="break-word">
						<tr>
							...
							<td class="niewypelniane" width="20%">Kwota / Amount doliczona do kwoty należności ogółem</td>
						</tr>
						<xsl:for-each select="tns:Obciazenia">
							<tr>
								...
								<td class="prawa" width="20%">
									<xsl:value-of select="tns:Kwota / Amount"/>
								</td>
							</tr>
						</xsl:for-each>
						<tr>
							<td class="niewypelniane" width="20%">Suma / Total obciążeń</td>
							<td class="prawa" width="80%">
								<xsl:value-of select="tns:Suma / TotalObciazen"/>
							</td>
						</tr>
					</table>
				</xsl:if>
				...
				<xsl:if test="tns:Odliczenia">
					...
					<table class="break-word">
						<tr>
							...
							<td class="niewypelniane" width="20%">Kwota / Amount odliczona od kwoty należności ogółem</td>
						</tr>
						...
						<tr>
							<td class="niewypelniane" width="20%">Suma / Total odliczeń</td>
							<td class="prawa" width="80%">
								<xsl:value-of select="tns:Suma / TotalOdliczen"/>
							</td>
						</tr>
					</table>
					<br/>
						...
						<tr>
							<xsl:choose>
								<xsl:when test="tns:DoZaplaty">
									<td class="niewypelniane" width="20%">Kwota / Amount należności do zapłaty równa kwocie należności ogółem powiększonej o sumę obciążeń i pomniejszonej o sumę odliczeń.</td>
									<td class="prawa" width="80%">
										<xsl:value-of select="tns:DoZaplaty"/>
									</td>
								</xsl:when>
								<xsl:when test="tns:DoRozliczenia">
									<td class="niewypelniane" width="20%">Kwota / Amount nadpłacona do rozliczenia/zwrotu</td>
									<td class="prawa" width="80%">
		...
		<xsl:for-each select="tns:Fa/tns:Platnosc">
			...
			<xsl:if test="tns:ZnacznikZaplatyCzesciowej|tns:ZaplataCzesciowa">
				...
				<table class="normalna">
					...
					<tr>
						<td class="niewypelniane" width="15%">Kwota / Amount zapłaty częściowej</td>
					...
					<xsl:for-each select="tns:ZaplataCzesciowa">
						<tr>
							<td class="prawa" width="15%">
								<xsl:value-of select="tns:Kwota / AmountZaplatyCzesciowej"/>
							</td>
	...
	<xsl:template name="WarunkiTransakcji">
		<xsl:if test="tns:Fa/tns:WarunkiTransakcji">
			<xsl:for-each select="tns:Fa/tns:WarunkiTransakcji">
				...
				<xsl:if test="tns:KursUmowny|tns:Waluta / CurrencyUmowna">
					<table width="100%">
						<tr>
							...
							<td class="niewypelniane" width="50%">Waluta / Currency umowna - kod waluty (ISO-4217) w przypadkach gdy na fakturze znajduje się informacja o kursie, po którym zostały przeliczone kwoty wykazane na fakturze w złotych. Nie dotyczy przypadków, o których mowa w dziale VI ustawy</td>
						</tr>
						<tr>
							...
							<td class="wypelniane" width="50%">
								<xsl:value-of select="tns:Waluta / CurrencyUmowna"/>
							</td>
						</tr>
					</table>
					<br/>
			...
			<xsl:for-each select="tns:Fa/tns:Zamowienie">
				...
				<table class="white-space">
					<tr>
						...
						<td class="niewypelniane">Cena jedn. / Unit priceostkowa netto</td>
						<td class="niewypelniane">Wartość sprzedaży netto zamówionego towaru lub zakres usługi</td>
						<td class="niewypelniane">Kwota / Amount VAT od zamówionego towaru lub usługi</td>
						<td class="niewypelniane">Stawka podatku</td>
						<td class="niewypelniane">Stawka podatku od wartości dodanej</td>
						<td class="niewypelniane">Klasyfikacja</td>
						<td class="niewypelniane">Kwota / Amount podatku akcyzowego zawarta w cenie towaru</td>
					...
					<xsl:for-each select="tns:ZamowienieWiersz">
						<tr>
							...
							<td class="prawa" width="auto">
								<xsl:value-of select="tns:Kwota / AmountAkcyzyZ"/>
							</td>
							<td class="srodek" width="auto">
				...
				<xsl:if test="tns:DaneFaKorygowanej">
					<table class="break-word">
						<tr>
							...
							<td class="niewypelniane" width="10%">Data wystawienia / Date of issue faktury korygowanej</td>
							<td class="niewypelniane" width="50%">Numer faktury / Invoice No korygowanej</td>
		...
		<xsl:if test="tns:Fa/tns:ZaliczkaCzesciowa">
			...
			<table class="break-word" width="60%">
				...
				<tr>
					...
					<td class="niewypelniane" width="20%">Kwota / Amount płatności, o której mowa w art. 106b ust. 1 pkt 4 ustawy, składająca się na kwotę ogółem. W przypadku faktur korygujących - korekta kwoty wynikającej z faktury korygowanej</td>
		...
		<xsl:if test="tns:Fa/tns:FakturaZaliczkowa">
			...
			<table class="break-word" width="100%">
				...
				<tr>
					...
					<td class="niewypelniane" width="48%">Numer faktury / Invoice No zaliczkowej wystawionej poza KSeF</td>
					<td class="niewypelniane" width="48%">Numer faktury / Invoice No zaliczkowej wystawionej w KsEF</td>
				</tr>
			...
			<xsl:for-each select="tns:Zalacznik/tns:BlokDanych">
				...
				<xsl:for-each select="tns:Tabela">
					...
					<table class="break-word" width="100%">
						...
						<xsl:for-each select="tns:Suma / Total">
							<tr>
